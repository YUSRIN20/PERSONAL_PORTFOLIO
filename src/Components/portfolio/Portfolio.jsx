...
const items = [
    {
        ...
        gitLink:"https://github.com/YUSRIN20/HotelBooking-Client-Side.git",
    ...
    },
    {
        ...
        gitLink:"https://github.com/YUSRIN20/Blog-Client-Side.git",
...

    {
        ...
        gitLink:"https://github.com/YUSRIN20/Bulk-Email-Tool-Frontend.git",
                ...
                <div className="wrapper">
                    ...
                    <motion.div className="textContainer" style={{ y }}>
                        ...
                        <div className='buttons'>
                            <button>
                                <a href={item.demoLink} target='blank'>See Demo <i class="fa-solid fa-eye"></i></a>
                            </button>
                            <button>
                                <a href={item.gitLink} target='blank'>See Repo <i class="fa-brands fa-github"></i></a>
                            </button>
                        </div>
                    </motion.div>
                </div>
